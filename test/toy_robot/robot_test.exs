defmodule ToyRobot.RobotTest do
  ...
  describe "when the robot is facing north, and it has moved forward one space" do
    setup  do
  ...
  describe "when the robot is facing east, and it has moved north one space" do
    setup do
  ...
  describe "when the robot is facing south and it moves south one space" do
    setup do
  ...
  describe "when the robot is facing west, and it has moved west one space" do
    setup do
